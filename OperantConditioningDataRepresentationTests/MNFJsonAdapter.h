...
/** 
 @description Deserializes a single object of type Class which is initialized with the json dictionary. If you want to do custom work on the json dictionary such as mapping or ignoring keys to deserialize look at the MNFJsonAdapterDelegate.
 ...
 @warning theError parameter is currently not used.
 */
...
/**
 @description Deserializes an array of objects of type Class which is initialized with an array of NSDictionaries.
 
 @see In order to do custom work on the json dictionary such as mapping or ignoring keys for deserialization look at the MNFJsonAdapterDelegate.
...
/** 
 ...
 @param theError An error the user can send by reference if something goes wrong in the serialization. Currenty not supported.
...
/**  
 ...
 @param theAdapterOption An option to change the keys of the dictionary if the json server uses a different formatting than the properties of theModel object passed as parameter.
 @param theError An error the user can send by reference if something goes wrong in the serialization. Currently not used.
